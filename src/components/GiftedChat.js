...
// import { GiftedAvatar,Time,Day, InputToolbar, LoadEarlier, Avatar, Actions, Bubble, MessageContainer, Message,MessageImage, MessageText, Composer, SystemMessage, Send } from 'react-native-gifted-chat'

import * as utils from 'react-native-gifted-chat/utils'
import Actions from 'react-native-gifted-chat/Actions'
import Avatar from 'react-native-gifted-chat/Avatar'
import Bubble from 'react-native-gifted-chat/Bubble'
import SystemMessage from 'react-native-gifted-chat/SystemMessage'
import MessageImage from 'react-native-gifted-chat/MessageImage'
import MessageText from 'react-native-gifted-chat/MessageText'
import Composer from 'react-native-gifted-chat/Composer'
import Day from 'react-native-gifted-chat/Day'
import InputToolbar from 'react-native-gifted-chat/InputToolbar'
import LoadEarlier from 'react-native-gifted-chat/LoadEarlier'
import Message from 'react-native-gifted-chat/Message'
import MessageContainer from 'react-native-gifted-chat/MessageContainer'
import Send from 'react-native-gifted-chat/Send'
import Time from 'react-native-gifted-chat/Time'
import GiftedAvatar from 'react-native-gifted-chat/GiftedAvatar'
...
import {
    ...
    TIME_FORMAT,
    DATE_FORMAT,
} from 'react-native-gifted-chat/Constant'
import {
    IMessage,
    User,
    Reply,
    ...
    MessageVideoProps,
    MessageAudioProps,
} from 'react-native-gifted-chat/Models'
import QuickReplies from 'react-native-gifted-chat/QuickReplies'
